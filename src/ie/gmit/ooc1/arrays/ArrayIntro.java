...
public class ArrayIntro {
	public static void main(String[] args) {
		...
		System.out.println(cars); // Prints the hashcode values of the objects but I want to print the values of these object
		...
		// Create an array that holds all values form 1 to 100 and print it to the console
