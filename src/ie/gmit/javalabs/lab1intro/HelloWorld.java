package ie.gmit.javalabs.lab1intro;
...
public class HelloWorld {    
	 ...
	 * It's the entry point for your application and will subsequently invoke 
	 * all the other methods required by your program. The main method accepts 
