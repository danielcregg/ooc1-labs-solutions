// https://www.thoughtco.com/how-to-build-a-simple-gui-application-javafx-code-2034067
package ie.gmit.javalabs2.gui;
...
//this is where we put the code for the user interface
	...
	public void start(Stage primaryStage) {
		...
		ListView<String> vegetables = new ListView<String>(FXCollections.observableArrayList("Apple", "Apricot", "Banana", "Cherry",
