...
public class Main {
	public static void main(String[] args) {
		...
		Car carObject2 = new Car("Nissan", 30000f, 100);

		// Set carObject1's properties
		carObject1.setMake("Ford");
		carObject1.setPriceEur(20000f);
		carObject1.setSpeedKph(120);

		// Print carObject1's properties
		System.out.println(carObject1.getMake());
		System.out.println(carObject1.getPriceEur());
		System.out.println(carObject1.getSpeedKph());

			// Print carObject2's properties
		System.out.println(carObject2.getMake());
		System.out.println(carObject2.getPriceEur());
		System.out.println(carObject2.getSpeedKph());
